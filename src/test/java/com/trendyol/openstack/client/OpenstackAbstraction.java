...
public abstract class OpenstackAbstraction {
    ...
    protected KeystoneToken keystoneToken;
    ...
    public OSClientSession.OSClientSessionV3 os3Session() {
        OSClientV3 osClientV3 = osv3();
        return OSClientSession.OSClientSessionV3.createSession(keystoneToken);
    }
